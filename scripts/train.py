...
def main():
    ...
    # Establecer MLflow Tracking URI (corregido para Ubuntu)
    ...
    try:
        ...
        if not os.path.exists(uri_path_base):
            ...
            os.makedirs(uri_path_base, exist_ok=True)  # ✔️ Ahora se crea si no existe
        ...
        logger.warning("Continuando con la configuración por defecto de MLflow (./mlruns)") # Corrected line, removed extra '}' and duplicated except
